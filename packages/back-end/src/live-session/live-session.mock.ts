...
export const generateMockLiveSessionTicketEntity = (): LiveSessionTicketEntity => {
...
export const generateMockLiveSessionPayload = (): LiveSessionPayload => ({ userId: generateRandomNumber() })
