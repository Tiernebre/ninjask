...
export const liveDraftSocketMiddleware = (draftService: DraftService, app: KoaWebsocket.App, logger: Logger): Middleware => route.all("/drafts/:id/live-pool", (ctx: Context, id: string) => {
  logger.info("RECEIVED REQUEST")

  void draftService.getLiveDraftPoolForOneWithId(Number(id)).then(draftStatus => {
